	...
	<div class="col-sm-8">
	 <div class="header_top_1r clearfix">
	   <ul class="nav navbar-nav navbar-right">
				...
				<li><a class="button mgt" href="donation.php">Donate Now!</a></li>
			</ul>
	 </div>
	</div>
   </div>
	   ...
	   <div class="header clearfix">
		...
		<div class="collapse navbar-collapse js-navbar-collapse">
			<ul class="nav navbar-nav">
				<li><a class="m_tag" href="index.php">Home</a></li>
				<li><a class="m_tag active_tab" href="about.html">About Us</a></li>
				<li><a class="m_tag" href="blog.html">Blog</a></li>
				<li><a class="m_tag" href="detail.html">Detail</a></li>
   ...
   <div class="about_page_1 clearfix">
	...
	<div class="col-sm-6">
	 <div class="about_page_1r clearfix">
	  ...
	  <p>We are a compassionate community dedicated to making a positive impact on the lives of those in need. Who we are goes beyond just a name; we are a group of individuals driven by a shared mission of spreading kindness and hope
		Our team is comprised of volunteers from diverse backgrounds, all united by a common goal: to uplift the vulnerable and marginalized. We believe that who we are as a society is reflected in how we care for our most vulnerable members.
	  </p>
	  <p>“Together, we are the driving force behind positive social change, and together, we can make the world a better place for all!”</p>
   ...
   <div class="history_2 mgt clearfix">
    <div class="col-sm-4">
	 <div class="history_2l clearfix">
	  ...
	  <div class="col-sm-9">
	   ...
	   <p>Social Welfare was founded in 2016 by a group of passionate individuals who saw a need for positive change in our community.
		 Since then, we have grown into an enormous strong team of dedicated professionals, volunteers, and partners, all working towards a common goal.</p>
	  </div>
	 </div>
	</div>
	<div class="col-sm-4">
	...
	<div class="col-sm-4">
	 <div class="history_2l clearfix">
	  ...
	  <div class="col-sm-9">
	   <h4 class="mgt bold">Our Values</h4>
	   <p>Compassion: We approach every individual and situation with empathy and understanding.
		Empowerment: We empower individuals and communities to create lasting change.
		Transparency: We are committed to transparency in all our actions and decisions.
	   </p>
	  </div>
	 </div>
	</div>
   ...
   <div class="team_p_1  clearfix">
    <div class="col-sm-3">
	 <div class="team_p_1i text-center clearfix">
	  ...
	  <p>American business tycoon, philanthropist, author</p>
	 </div>
	</div>
	<div class="col-sm-3">
	 <div class="team_p_1i text-center clearfix">
	...
	<div class="col-sm-3">
	 <div class="team_p_1i text-center clearfix">
	  ...
	  <p>co-founder and chairman of Intel corporation</p>
	 </div>
	</div>
	<div class="col-sm-3">
	 <div class="team_p_1i text-center clearfix">
	  ...
	  <p>chairman of the bank of Oklahoma financial corporation</p>
	 </div>
	</div>
   </div>
  </div>
